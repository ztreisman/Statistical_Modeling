...
![](figures/r-interface-2020.png){width="4in"}
...
![](figures/newScript.png){width="4in"}
...
-   If you include code and output, use a \texttt{fixed width (typewriter) font} for code and output and another font for text.
