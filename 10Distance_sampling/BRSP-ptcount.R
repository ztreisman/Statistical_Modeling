...
# Print results
knitr::kable(BRSP.tab, caption="Results from point transect data.", digits=3)
...
# Print results
knitr::kable(BRSP.tab, caption="Results from point transect data with covariates (year, observer).", digits=3)
